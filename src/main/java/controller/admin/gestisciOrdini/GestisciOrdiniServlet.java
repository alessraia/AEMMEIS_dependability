...
public class GestisciOrdiniServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            log("Errore durante il forward verso /WEB-INF/results/admin/ordini/gestisciOrdini.jsp", e);
        } catch (IOException e) {
            log("Errore di I/O durante il forward verso /WEB-INF/results/admin/ordini/gestisciOrdini.jsp", e);
        }
    }
}
